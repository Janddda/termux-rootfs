...
(function() {
    ...
    function upload(file) {
        ...
        li.append($('<div class="upload-progress"></div>'));
        $(li).appendTo($('.queue'));
        ...
        xhr.upload.addEventListener("progress", function(e) {
            ...
            var seconds_elapsed = (new Date().getTime() - started_at) / 1000;
            var speed = seconds_elapsed ? e.loaded / seconds_elapsed : 0;
            ...
            $('.upload-progress', $(li)).empty().append("Uploading " + file.name + "... [" + percentage + "%, " + speed + " " + speed_unit +"]");
        }, false);
